package main.cargo.exception.unckecked;
...
public class CargoDeleteConstraintViolationException extends OurCompanyException {
  ...
  private static final String MESSAGE = "Cant delete main.cargo with id '%s'. There are transportations which relates to it!";
